...
namespace Ejer2API_AlejandroSerafinParedes.Controllers
{
    ...
    public class GenresController : ControllerBase
    {
        ...
        public GenresController(Ejer2API_AlejandroSerafinParedesContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Genre>> PostGenre(Genre genre)
        {
          if (_context.Genre == null)
          {
              return Problem("Entity set 'Ejer2API_AlejandroSerafinParedesContext.Genre'  is null.");
          }
